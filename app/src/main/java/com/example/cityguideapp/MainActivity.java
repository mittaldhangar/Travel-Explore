...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public List<CityPlace> GetPlaces(String type) {
        ...
        Request request = new Request.Builder()
                .url("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+latitude+","+longitude+"&radius=30000&type=" + type + "&key=" + apiKey)
                .method("GET", null)
                .build();
        ...
        try {
            ...
            for (int objIndex = 0; objIndex < jsonArray.length(); objIndex++) {
                ...
                places.add(new CityPlace(name, address, imageUrl));
            }
        }
        catch (Exception e) {
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.c4 :
                i = new Intent(this, transporstation.class);
                startActivity(i);
                break;
